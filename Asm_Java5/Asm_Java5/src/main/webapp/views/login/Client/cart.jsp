    ...
    <div class="row px-xl-5">
        <div class="col-12">
            <nav class="breadcrumb bg-light mb-30">
                <a class="breadcrumb-item text-dark" href="/home_client/${US.id}">Home</a>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                <c:forEach items="${cart}" var="c">
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="/cart/${US.id}/xoaAo/${c.idSP}" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                </c:forEach>
            ...
            <a class="btn btn-primary mb-2" href="/home_client/${US.id}"><i class="fa fa-angle-right mr-2"></i>ADD MORE...</a>
        </div>
        <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-secondary mb-2" href="/home_client/${US.id}"><i class="fa fa-angle-right mr-2"></i>Home</a>
