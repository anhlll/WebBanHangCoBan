    ...
    <div class="row px-xl-5">
                ...
                <div class="carousel-inner bg-light">
                    ...
                    <center>
                        <div class="carousel-item active">
                            <img src="/image/${product.image}" height="250" />
                        </div>
                    </center>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <h3 class="font-weight-semi-bold mb-4">${product.giaban}</h3>
                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero. Quidem magni
                    dolorum incidunt optio dolorem, fugit error eligendi ad debitis, quia atque id officia pariatur
                    quibusdam omnis deleniti. Quibusdam!y</p>
...
<%--                    <a href="/cart/${US.id}/add-tai-nghe/${product.idSP}" class="btn btn-primary">Add to Cart</a>--%>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="media mb-4">
                                    <img src="img/anhuser.png" class="img-fluid mr-3 mt-1"
                                         style="width: 45px;">
