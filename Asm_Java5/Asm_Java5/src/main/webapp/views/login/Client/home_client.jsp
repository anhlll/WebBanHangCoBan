        ...
        <div class="col-lg-3 d-none d-lg-block">
            <a class="btn d-flex align-items-center justify-content-between bg-light w-100" data-toggle="collapse"
               href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                <h6 class="text-dark m-0"><i class="fa mr-2"></i>Hello ${US.ten}</h6>
                    ...
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                <a href="/cart-view/${US.id}" class="dropdown-item">Giỏ hàng</a>
    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${page.getContent()}" var="sp">
            <tr>
                ...
                <td>${sp.mota}</td>
                <td>
                    <a href="/cart/${US.id}/add-San-Pham/${sp.idSP}" class="btn btn-primary">Add to Cart</a>
