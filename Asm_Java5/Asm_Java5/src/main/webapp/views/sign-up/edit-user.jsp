...
<form:form class="login-form" id="registerForm" method="post" action="/update-user/${khachHang.id}" modelAttribute="khachhang" >
    <div class="form-group">
        <label for="username">Mã :</label>
        <input type="text" class="form-control" id="ma" name="ma" value="${khachHang.ma}" required>
    </div>
    <div class="form-group">
        <label for="username">Họ và tên:</label>
        <input type="text" class="form-control" id="username" name="ten" value="${khachHang.ten}" required>
    </div>
    <div class="form-group">
